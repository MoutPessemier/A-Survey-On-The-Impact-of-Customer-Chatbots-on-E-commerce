...
\begin{enumerate}
	...
	\item H1: Current chatbots execute requested tasks correctly. Based on \citeauthor{Verkeyn2018} quality attribute “Execute requested tasks” from the dimension “Functionality” \citep{Verkeyn2018} (\acrshort{qa} 1).
	\item H2: Current chatbots can deliver the same services as a human agent. Based on \citeauthor{Verkeyn2018} quality attribute “Number of services available in the chatbot” from the dimension “Functionality”  \citep{Eeuwen2017} (\acrshort{qa} 2).
	\item H3: Current chatbots contain enough knowledge to provide good assistance. Based on \citeauthor{Verkeyn2018} quality attribute “Contains breadth of knowledge” from the dimension “Trustworthiness” \citep{Cohen2016, Kuligowska2015} (\acrshort{qa} 3).
\end{enumerate}
...
\begin{table}[!h]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|}
			\hline
			\textbf{H1} &
			\begin{tabular}[c]{@{}l@{}}- Did the chatbot fulfil your task correctly?\\ - Was the chatbot unable to complete your task?\\ - Did the chatbot need help from a help desk agent to complete your task?\\ - Was the chatbot capable of completing the task on its own?\\ - Did the chatbot perform the task as you expected it to?\\ - Could you solve your problem/question after using the chatbot\end{tabular} \\ \hline
			\textbf{H2} &
			\begin{tabular}[c]{@{}l@{}}- Did the chatbot deliver a better quality of service than a human?\\ - The service provided by the human was of better quality?\end{tabular} \\ \hline
			\textbf{H3} &
			\begin{tabular}[c]{@{}l@{}}- Did the chatbot contain enough knowledge to help with your problem?\\ - The chatbot did not know what he was talking about?\\ - Did the chatbot ask you relevant questions to gather the information to solve your task?\\ - The chatbot did not know what he was talking about?\end{tabular} \\ \hline
			\textbf{H4} &
			\begin{tabular}[c]{@{}l@{}}- Was the chatbot easy to use?\\ - Did you have any difficulties using the chatbot?\end{tabular} \\ \hline
			\textbf{H5} &
			\begin{tabular}[c]{@{}l@{}}- Was the chatbot polite?\\ - Did the chatbot interact in a respectful way?\\ - Did you enjoy interacting with the chatbot?\\ - Was it a task to interact with the chatbot\end{tabular} \\ \hline
		\end{tabular}%
	}
