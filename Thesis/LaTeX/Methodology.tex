...
\begin{table}[!h]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|}
			...
			\textbf{H3} &
			\begin{tabular}[c]{@{}l@{}}- Did the chatbot contain enough knowledge to help with your problem?\\ - The chatbot didn't know what he was talking about?\\ - Did the chatbot ask you relevant questions to gather the information to solve your task?\\ - The chatbot didn't know what he was talking about?\end{tabular} \\ \hline
			\textbf{H4} &
